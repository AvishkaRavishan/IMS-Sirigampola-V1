...
// Commented out the checkLogin function for study purposes
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6" align="right">
                            <button type="button" name="add" id="addCustomer" data-bs-toggle="modal"
                                ...
                                class="btn btn-primary bg-gradient btn-sm rounded-0"><i
                                    class="far fa-plus-square"></i> New Customer</button>
                        </div>
                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered  rounded-0">
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-sm rounded-0 btn-default border"
